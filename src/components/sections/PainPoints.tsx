...
const cards = [
  {
    ...
    title: "Revenue Loss",
    points: [
      "Peak-hour outages cost $5k–$50k per minute",
      "Broken campaigns waste entire ad budgets",
      "Each outage drives users to competitors",
    ],
  },
  {
    num: "02",
    title: "Hidden Costs",
    points: [
      "Over-provisioned infrastructure drains budgets",
      "Reactive firefighting wastes engineer hours",
  ...
  },
  {
    ...
    points: [
      "Unpatched systems expose critical data",
      "No audit trails for compliance",
      "DDoS attacks with no mitigation plan",
    ],
  },
];
    ...
    >
      {cards.map((card) => (
        <motion.div
          key={card.num}
          variants={fadeUp}
          className="group rounded-2xl bg-card p-8 shadow-[0_1px_3px_0_hsl(var(--foreground)/0.04),0_8px_24px_-4px_hsl(var(--foreground)/0.06)] transition-transform duration-300 hover:-translate-y-1"
        >
